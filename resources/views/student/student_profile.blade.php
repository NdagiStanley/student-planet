        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4 list-group">
                ...
                <p class="list-group-item-text">
                    a student that is looking to get experience in the workforce through the opportunities that will be provided in this platform, get to build my skills and learn from others in my field of expertise.</p>
                </a>
            </div>
        </div>
        <div class="col-md-12">
